...
MissileWeaponData missile_data[MW_Count] =
{
    ...
    MissileWeaponData(100.0f, 10.f, 40.0f, sf::Color(255, 200, 0), 200.0, "sfx/rlaunch.wav"),/*MW_Homing*/
    ...
    MissileWeaponData(800.0f,  0.f, 13.5f, sf::Color(200, 200, 200), 0.0, "sfx/hvli_fire.wav"),/*MW_HVLI -- Now used for Macrocannons*/
};
