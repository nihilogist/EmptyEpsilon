...
function createNPCShipConfig()
    npcConfiguration = {
        ...
        {"Malevolence", -451, 2942, 270, "Merchant Raider", "Children of Tain", "Metallic object. Mass reading 700.500IT. Thermal signature variable, consistent with plasma reactor.", "Voidship. Caballus-pattern Imperial Freightship. Biosignatures present. Reactor active.", "Negative Ident Patternmatch. IFF broadcast callsign MALEVOLENCE. Weapon batteries detected."},
        {"Stormspike", -1176, 3451, 270, "Armed Merchantman", "Children of Tain", "Metallic object. Mass reading 550.300IT. Thermal signature variable, consistent with plasma reactor.", "Voidship. Asinus-pattern Imperial Freightship. Biosignatures present. Reactor Active.", "Negative Ident Patternmatch. IFF broadcast callsign STORMSPIKE. Weapon batteries detected."},
        ...
        {"Sabre's Point", 8640, -7610, 0, "Pirate Destroyer", "Kirill", "Metallic object. Mass reading 848,000IT. Thermal signature variable, consistent with Naval plasma reactor.", "Voidship. Cobra-pattern Destroyer class. Biosignatures present. Reactor active", "Pattern match CallsignDesignate \"Sabre's Point\" att. Battlefleet Prosperitas. Weapon batteries detected."},
        {"Maw's Revenge", 7492, -9318, 0, "Falchion", "Kirill", "Metallic object. Mass reading 895,000IT. Thermal signature variable, consistent with Naval plasma reactor.", "Voidship. Sword-pattern Frigate class. Biosignatures present. Reactor active.", "Cogitator Pattern mismatch error. Pattern match CallsignDesignate \"Anguine Moros\" att. Battlefleet Prosperitas. Broadcast Ident \"Maw's Revenge\". Weapon batteries detected."},
