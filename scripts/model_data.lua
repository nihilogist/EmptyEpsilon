model = ModelData()
model:setName("emperorClassBattleship")
...
model:setScale(6)
model:setRadius(600)
model:setCollisionBox(1800, 450)

model = ModelData()
model:setName("dauntlessLightCruiser")
model:setMesh("space_station_4/space_station_4.model")
model:setTexture("space_station_4/space_station_4_color.jpg")
model:setSpecular("space_station_4/space_station_4_specular.jpg")
model:setIllumination("space_station_4/space_station_4_illumination.jpg")
...
model:setScale(6)
model:setRadius(600)
model:setCollisionBox(600, 150)

model = ModelData()
model:setName("swordClassFrigate")
model:setMesh("space_station_4/space_station_4.model")
model:setTexture("space_station_4/space_station_4_color.jpg")
model:setSpecular("space_station_4/space_station_4_specular.jpg")
model:setIllumination("space_station_4/space_station_4_illumination.jpg")
...
model = ModelData()
model:setName("lunarClassCruiser")
model:setMesh("space_station_4/space_station_4.model")
model:setTexture("space_station_4/space_station_4_color.jpg")
model:setSpecular("space_station_4/space_station_4_specular.jpg")
model:setIllumination("space_station_4/space_station_4_illumination.jpg")
...
model:setScale(6)
model:setRadius(800)
model:setCollisionBox(1000, 200)

model = ModelData()
model:setName("cobraDestroyer")
model:setMesh("space_station_4/space_station_4.model")
model:setTexture("space_station_4/space_station_4_color.jpg")
model:setSpecular("space_station_4/space_station_4_specular.jpg")
model:setIllumination("space_station_4/space_station_4_illumination.jpg")
...
model:setScale(6)
model:setRadius(450)
model:setCollisionBox(450, 120)

model = ModelData()
model:setName("furyInterceptor")
model:setMesh("space_station_4/space_station_4.model")
model:setTexture("space_station_4/space_station_4_color.jpg")
model:setSpecular("space_station_4/space_station_4_specular.jpg")
model:setIllumination("space_station_4/space_station_4_illumination.jpg")
...
model:setScale(10)
model:setRadius(720)
model:setCollisionBox(1440, 1440)
